...
<div id="sidebar" class="font-sans sidebar bg-white w-[240px] h-full fixed flex flex-col overflow-y-auto top-0 left-0 z-50 shadow-xl px-4 py-6 transition-all duration-300">
    @php
        $user = auth()->user();
